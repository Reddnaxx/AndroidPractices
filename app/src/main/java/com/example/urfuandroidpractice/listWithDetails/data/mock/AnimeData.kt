...
object AnimeData {
    ...
    val animeFull = listOf(
        AnimeFullEntity(
            ...
            genres = listOf(
                AnimeGenre(id = 27, name = "Shounen", russian = "Сёнен"),
                AnimeGenre(id = 1, name = "Action", russian = "Экшен"),
                AnimeGenre(id = 8, name = "Drama", russian = "Драма"),
                AnimeGenre(id = 41, name = "Thriller", russian = "Триллер"),
                AnimeGenre(id = 38, name = "Military", russian = "Военное")
            )
        ),
        AnimeFullEntity(
            id = 1535,
            ...
            genres = listOf(
                AnimeGenre(id = 27, name = "Supernatural", russian = "Сверхъестественное"),
                AnimeGenre(id = 1, name = "Thriller", russian = "Триллер"),
                AnimeGenre(id = 8, name = "Psychological", russian = "Психологическое"),
                AnimeGenre(id = 41, name = "Shounen", russian = "Сёнен"),
            )
        ),
        AnimeFullEntity(
            id = 5114,
            ...
            genres = listOf(
                AnimeGenre(id = 27, name = "Adventure", russian = "Приключения"),
                AnimeGenre(id = 1, name = "Military", russian = "Военное"),
                AnimeGenre(id = 8, name = "Drama", russian = "Драма"),
                AnimeGenre(id = 41, name = "Magic", russian = "Магия"),
                AnimeGenre(id = 38, name = "Fantasy", russian = "Фэнтези")
            )
        ), AnimeFullEntity(
            id = 30276,
            name = "One Punch Man",
            ...
            genres = listOf(
                AnimeGenre(id = 27, name = "Comedy", russian = "Комедия"),
                AnimeGenre(id = 1, name = "Action", russian = "Экшен"),
                AnimeGenre(id = 8, name = "Parody", russian = "Пародия"),
                AnimeGenre(id = 41, name = "Super Power", russian = "Супер сила"),
                AnimeGenre(id = 38, name = "Seinen", russian = "Сейнен")
            )
        )
    )
}