...
object AnimeData {
    ...
    val animeFull = listOf(
        AnimeFullModel(
            ...
            genres = listOf(
                AnimeGenre(id = 27, name = "Shounen", russian = "Сёнен", entryType = "Anime"),
                AnimeGenre(id = 1, name = "Action", russian = "Экшен", entryType = "Anime"),
                AnimeGenre(id = 8, name = "Drama", russian = "Драма", entryType = "Anime"),
                AnimeGenre(id = 41, name = "Thriller", russian = "Триллер", entryType = "Anime"),
        ...
        AnimeFullModel(
            ...
            genres = listOf(
                ...
                AnimeGenre(id = 1, name = "Thriller", russian = "Триллер", entryType = "Anime"),
                AnimeGenre(
                    id = 8,
                    name = "Psychological",
        ...
        AnimeFullModel(
            ...
            genres = listOf(
                ...
                AnimeGenre(id = 1, name = "Military", russian = "Военное", entryType = "Anime"),
                AnimeGenre(id = 8, name = "Drama", russian = "Драма", entryType = "Anime"),
            ...
            genres = listOf(
                AnimeGenre(id = 27, name = "Comedy", russian = "Комедия", entryType = "Anime"),
                AnimeGenre(id = 1, name = "Action", russian = "Экшен", entryType = "Anime"),
                AnimeGenre(id = 8, name = "Parody", russian = "Пародия", entryType = "Anime"),
                AnimeGenre(
                    id = 41,
                    name = "Super Power",
                    russian = "Супер сила",
                ...
                AnimeGenre(id = 38, name = "Seinen", russian = "Сейнен", entryType = "Anime")
            )
        )
    )
}