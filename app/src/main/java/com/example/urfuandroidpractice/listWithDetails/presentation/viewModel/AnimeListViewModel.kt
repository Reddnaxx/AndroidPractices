...
class AnimeListViewModel(
    private val repository: IAnimeRepository, private val navigation: StackNavContainer
) : ViewModel() {
    ...
    private fun loadAnime() {
        viewModelScope.launch {
            repository.getList(q = mutableState.query.value, page = mutableState.page)
                .onStart { setLoadingState() }.catch { mutableState.error = it.message }
